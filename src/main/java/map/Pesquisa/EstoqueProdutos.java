...
public class EstoqueProdutos {
    ...
    public Produto obterProtutoMaisCaro(){
        Produto produtoMaisaCaro = null;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Produto mais barato: " + estoqueProdutos.obterProtutoMaisCaro());
    }
}
